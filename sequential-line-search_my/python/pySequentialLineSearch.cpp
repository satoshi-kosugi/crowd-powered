...
PYBIND11_MODULE(pySequentialLineSearch, m)
{
    ...
    optimizer_class.def(
        "add_line_search_result",
        static_cast<void (SequentialLineSearchOptimizer::*)(const Eigen::VectorXd&, const Eigen::VectorXd&, const Eigen::VectorXd&)>(
            &SequentialLineSearchOptimizer::AddLineSearchResult),
        "x_chosen"_a,
        "end_0"_a,
        "end_1"_a);
    ...
    optimizer_class.def("print_test", &SequentialLineSearchOptimizer::PrintTest);
